...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "MotorSM.h"
// the name of the Init function
#define SERV_1_INIT InitMotorSM
// the name of the run function
#define SERV_1_RUN RunMotorSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "EncoderService.h"
// the name of the Init function
#define SERV_2_INIT InitEncoderService
// the name of the run function
#define SERV_2_RUN RunEncoderService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "BeaconService.h"
// the name of the Init function
#define SERV_3_INIT InitBeaconService
// the name of the run function
#define SERV_3_RUN RunBeaconService
// How big should this services Queue be?
...
typedef enum
{
  ...
  ES_CW_TAPE,        
  ES_STOP,
  ES_SIDEBEACON_DETECT,
  ES_FRONTBEACON_DETECT,
  ES_FROM_LEADER,
  ES_LOOK_FOR_BEACON,
  ES_START_TURN_90,
  ES_ENCODER_UPDATE_STOP,
  ES_ENCODER_UPDATE_LEFT,
  ES_ENCODER_UPDATE_RIGHT,
  ES_DRIVEFORWARD,
  ES_DRIVEFORWARD_5,
  ES_DRIVEFORWARD_10,
  ES_DRIVEBACKWARD,
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4BackRightLine, Check4CenterMiddleLine// Check4Line
...
#define TIMER15_RESP_FUNC PostMotorSM
...
#define ADC_UPDATE_TIMER 15
#define DOUBLE_DELAY 14

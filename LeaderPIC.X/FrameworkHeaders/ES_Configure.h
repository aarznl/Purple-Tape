...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "TopLevelHSM.h"
// the name of the Init function
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "OrientationService.h"
// the name of the Init function
#define SERV_5_INIT InitOrientationService
// the name of the run function
#define SERV_5_RUN RunOrientationService
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4ButtonDown, Check4SwitchPushed// Check4Line
...
#define TIMER15_RESP_FUNC PostSPILeaderService
...
#define COLLECT_TIMER 13
#define TOBUCKET_TIMER 12
#define DISPENSE_TIMER 11
#define ORIENT_TIMER 10
#define FORWARD_TIMER 9
#define SERVO_TIMER 8
